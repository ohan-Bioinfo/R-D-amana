...
.nucleus .card{text-align:center;max-width:150px}
.nucleus .val{font-family:'IBM Plex Mono',monospace;font-weight:600;font-size:21px;letter-spacing:-1px;color:var(--green-2);line-height:1}
.nucleus .lab{font-size:9px;letter-spacing:1px;text-transform:uppercase;color:var(--muted);margin-top:3px}
...
const side=Math.min(720, Math.max(520, el.clientWidth||700));
