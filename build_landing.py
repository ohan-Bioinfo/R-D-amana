...
/* chemistry is under construction: big ✕ over the plate instead of the ornament */
.plate .glyph.cross{font-size:34px;font-weight:700;color:var(--peri);opacity:.85}
.lab.chem:hover .ring{animation:none}
    ...
    <section class="lab chem">
      <div class="lab-top">
        <div class="plate">
          ...
          <span class="glyph cross" title="Under construction · قيد الإنشاء">✕</span>
        </div>
        <div class="names">
          <div class="kicker">Laboratory</div>
          <h2>Chemistry</h2>
